...
export default function VideoInputList() {
  ...
  const localVideoInputDeviceId =
    mediaStreamTrack === null || mediaStreamTrack === void 0 ? void 0 : mediaStreamTrack.getSettings().deviceId;
  function replaceTrack(newDeviceId) {
    localVideoTrack.restart(
      Object.assign(Object.assign({}, DEFAULT_VIDEO_CONSTRAINTS), { deviceId: { exact: newDeviceId } })
    );
  }
  return (
    <div>
      {videoInputDevices.length > 1 ? (
        ...
        <>
          <Typography variant="h6">Video Input:</Typography>
          <Typography>
            {(localVideoTrack === null || localVideoTrack === void 0
              ? void 0
