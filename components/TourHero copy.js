          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              <div className="text-sm font-semibold uppercase tracking-wide text-gray-500 sm:text-base lg:text-sm xl:text-base">
                EN Etapa de Planemiento
              </div>
              <h2 className="mt-1 text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:leading-none sm:text-6xl lg:text-5xl xl:text-6xl">
                PYMES
                <br className="hidden md:inline" />
                <span className="text-red-600">HIBRIDO DIGITAL</span>
              </h2>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                En una aceleradora nacional que utiliza tecnología, capacitación
                e inversión para impulsar el crecimiento de pequeñas y medianas
                empresas.
              </p>

              <p className="mt-3 text-base text-red-900 sm:mt-5 sm:text-xl lg:text-xl xl:text-xl">
                Su misión es acelerar la conversción de empresas tradicionales
